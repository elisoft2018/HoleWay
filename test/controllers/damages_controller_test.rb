...
class DamagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create damage" do
    assert_difference('Damage.count') do
      post damages_url, params: { damage: { enabled: @damage.enabled, level: @damage.level, name: @damage.name, severity: @damage.severity } }, as: :json
    end
  ...
  test "should update damage" do
    patch damage_url(@damage), params: { damage: { enabled: @damage.enabled, level: @damage.level, name: @damage.name, severity: @damage.severity } }, as: :json
    assert_response 200
  end
